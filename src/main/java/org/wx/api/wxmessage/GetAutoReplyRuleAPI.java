...
import org.wx.api.core.req.model.message.auto.AutoReplyRuleGet;
...
import org.wx.api.wxmessage.model.auto.KeyWordAutoReplyInfo;
import org.wx.api.wxmessage.model.auto.KeywordListInfo;
import org.wx.api.wxmessage.model.auto.ReplyListInfo;
 ...
 *
 */
public class GetAutoReplyRuleAPI {
	private static Logger logger = LoggerFactory.getLogger(GetAutoReplyRuleAPI.class);
	...
	public static void main(String[] args) {
		try {
			...
			GetAutoReplyRuleAPI.getAutoReplyInfoRule(s);
