...
public class WeiXinReqUtil {
	...
	public static void initReqConfig(String configName) throws JDOMException, IOException{
		...
		for(Element mapping :lstMapping){
			...
			String mappingHandler ="org.wx.api.core.handler.impl.WeixinReqDefaultHandler";
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static Map<String,Object> getWeixinReqParam(WeixinReqParam weixinReqParam){
		Gson gson = new Gson();
...
//		System.out.println(realPath);
		...
		WeixinReqConfig wxreqconfig = WeiXinReqUtil.getWeixinReqConfig("access_token");
		System.out.println("key=="+wxreqconfig.getKey() + "  dateType=="+wxreqconfig.getDatatype());
